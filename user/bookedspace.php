    ...
    <div class="col-md-12">
        <div class="card mt-3">
            ...
            <div class="card-body">
                <?php
                $query = "
                    SELECT userspace.userSpaceId, space.space_id, space.location, space.lat, space.lng, 
                ...
                if($result->num_rows >0){
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        $ownerPhone = htmlspecialchars($row['owner_phone']);
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <button class='btn btn-info btn-sm' onclick='showOwnerDetails(\"{$ownerName}\",\"{$ownerPhone}\")'>View Details</button>
                                </td>
                                <td>
                    ...
                    echo '<div class="alert alert-warning">You have no bookings to show.</div>';
                }
                $stmt->close();
                $conn->close();
                ?>
