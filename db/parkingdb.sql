...
INSERT INTO `tblvehicle` (`ID`, `UserId`, `ParkingNumber`, `VehicleCategory`, `VehicleCompanyname`, `RegistrationNumber`, `InTime`, `OutTime`, `ParkingCharge`, `Remark`, `Status`) VALUES
(1, 2, 'PN-101', 'Car', 'Toyota', 'BA-2-CHA-1234', '2025-08-10 09:01:43', NULL, '200', 'Regular parking', 'IN'),
(2, 3, 'PN-102', 'Motorbike', 'Honda', 'BA-5-PA-5678', '2025-08-10 09:01:43', NULL, '50', 'Short-term parking', 'OUT');
